            ...
            <div className="hero-contact-left track-panel">
              {!result ? (
                ...
                <div className="track-result">
                  ...
                  {result.phase === "completed" ? (
                    <p className="track-form-error" role="status" style={{ color: "inherit" }}>
                      This job is marked complete on the workshop board. Tracking here does not
                      show payment — contact the workshop if you still need collection or a
                      receipt.
                    </p>
                  ) : null}
                  ...
                  <div className="track-summary-grid">
                    ...
                    <div className="track-summary-card">
                      <div className="track-summary-label">
                        {result.phase === "completed" ? "Workshop" : "Where your car is"}
                      </div>
            ...
            <div className="hero-contact-right">
              ...
              <div className="contact-details track-help-card">
                ...
                <ul className="track-help-list">
                  ...
                  <li>Current workshop stage (open jobs first; completed jobs still show)</li>
                  <li>Estimated collection time when set</li>
                  <li>No prices, payment status, or invoices — those stay in the workshop</li>
                </ul>
              </div>
